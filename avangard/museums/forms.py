...
class MuseumForm(ModelForm):
    class Meta:
        model = Museum
        fields = ['name', 'fullticket_price', 'reduceticket_price', 'audioguide_price', 'accompanying_guide_price', 'max_count', 'voucher_numbers']
        widgets = {
            ...
            'voucher_numbers': forms.TextInput(attrs={'class': 'form-control'})
        }
